              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        "${widget.expenseData["ExpenseName"]}",
                        style: TextStyle(
                            fontSize: 16,
                            color: Colors.grey[800],
                            fontWeight: FontWeight.w600),
                      ),
                      widget.expenseData["PaymentType"].toString().toLowerCase() ==
                              "cash"
                          ? Text(
                          ...
                          : widget.expenseData["RefNo"] != ""
                              ? Text(
                                  "Ref No: ${widget.expenseData["RefNo"]}",
                                  style: TextStyle(
                                      fontSize: 14, color: Colors.grey[600]),
                                )
                              : Container(),
                      Text(
                        "${widget.expenseData["Notes"]}",
