...
class _VisitorOutSideComponentState extends State<VisitorOutSideComponent> {
  var date, newDt, monthNumber, dateNumber,outDate,newOutDate,newMonthNumber,newDateNumber;
  ...
  void initState() {
    ...
    if (widget._visitorOutSideList["outDateTime"].length != 0) {
      ...
      newMonthNumber =
      widget._visitorOutSideList["inDateTime"][0].toString().split("/")[1];
      newDateNumber =
      widget._visitorOutSideList["inDateTime"][0].toString().split("/")[0];
      date = DateTime.parse(widget._visitorOutSideList["inDateTime"][0]
              .toString()
              .split("/")[2] +
          "-" +
          newMonthNumber +
      ...
      outDate = DateTime.parse(widget._visitorOutSideList["outDateTime"][0]
          .toString()
          .split("/")[2] +
          "-" +
          monthNumber +
          ...
          " " +
          "00:00:00.000000");
      newOutDate = DateFormat.yMMMEd().format(outDate);
    }
  ...
  allWingsAndFlats(){
    print("called");
    wingsAndFlats.clear();
    for (int i = 0; i < widget._visitorOutSideList["FlatData"].length; i++) {
      if (i == widget._visitorOutSideList["FlatData"].length - 1 && !wingsAndFlats.contains(Text(
        "${widget._visitorOutSideList["WingData"][i]["wingName"]}-${widget
            ._visitorOutSideList["FlatData"][i]["flatNo"]}",
        style: TextStyle(
          fontSize: 13,
      ...
      else if(!wingsAndFlats.contains(Text(
        "${widget._visitorOutSideList["WingData"][i]["wingName"]}-${widget
            ._visitorOutSideList["FlatData"][i]["flatNo"]}" + " , ",
        style: TextStyle(
          fontSize: 13,
      ...
      child: Row(
        ...
        children: <Widget>[
          Padding(
            ...
            child: widget._visitorOutSideList["guestImage"] == "" ? Image.asset("images/user.png",
                width: 50, height: 50, fit: BoxFit.fill): ClipOval(
          ...
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                ...
                // widget._visitorOutSideList["WingData"].length > 0 ? Padding(
                //   padding: const EdgeInsets.only(left: 8.0),
                //   child: Text(
