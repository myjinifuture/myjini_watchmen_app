...
class _EnterCodeScanScreenState extends State<EnterCodeScanScreen>
  ...
  _getLocaldata() async {
    ...
    societyName = prefs.getString(constant.Session.societyName);
  ...
  showVisitorImage(String msg,String image,var entryData, {String title = 'MYJINI'}) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return SizedBox(
        ...
        SizedBox(
          ...
          child: RaisedButton(
              ...
              onPressed: () {
                ...
                print(inputCode);
                imagePresent(inputCode,societyId,[]);
                // _getVisitorData(inputCode,WatchManId);
                // _getVisitorData(inputCode, WatchManId);
              }),
        )
          ...
          if (data.Data.length > 0) {
            setState(() {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => FromMemberScreen(fromMemberData: data.Data[0],unknown : true,id:data.Data[0]["EntryId"],isAudioCall : isAudioCall),
                ),
              );
            });
          } else {
                ...
                child: new Column(
                  children: <Widget>[
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: Container(
                              child: InkWell(
                                child:
                                societyName!=null ? Center(
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("Society : " + societyName.toUpperCase(),
                                        style: TextStyle(
                                          color: Colors.purple,
                                            fontSize: 15,
                                            fontWeight: FontWeight.bold,
                    ...
                    _firstDigit!=null
                        ...
                        && _fourthDigit!=null
                        && _fifthDigit!=null
                        && _sixthDigit!=null ? Padding(padding: EdgeInsets.only(top: 1)) : Padding(padding: EdgeInsets.only(top: 20)),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                height: _firstDigit!=null
                                    && _secondDigit!=null
                                    && _thirdDigit!=null
                                    && _fourthDigit!=null
                                    && _fifthDigit!=null
                                    && _sixthDigit!=null ? MediaQuery.of(context).size.height*0.05 : 40,
                                decoration: BoxDecoration(
